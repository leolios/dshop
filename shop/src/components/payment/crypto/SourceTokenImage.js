 ...
 * @returns <Promise<string>> if the tokenChecksumAddress has a valid Token Image in the TrustWallet repository.
...
const TryEthLists = (tokenChecksumAddress) => {
  ...
  // getLogoSource: <Promise<string>> if tokenChecksumAddress has valid data in the EthLists repo
